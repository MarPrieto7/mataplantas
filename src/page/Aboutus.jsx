    ...
    return (
      <section className="about-us">
        ...
        <section class="about-content">
                ...
                <p>
                    ¿Tienes una planta que no ha pasado la prueba del tiempo? ¡No te preocupes! En Matoplantas, creemos en segundas oportunidades. ¡Trae tu planta moribunda y te daremos un descuento tan grande que ni siquiera la Planta de la Abuela podría resistirse! Sí, ¡aquí honramos a las plantas que han pasado a mejor vida con descuentos que te harán resucitar de la emoción!
                </p>
                </div>
